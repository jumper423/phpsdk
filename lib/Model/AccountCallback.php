...
class AccountCallback implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'balance' => 'int',
        'currency' => 'string',
        'account_document_verified' => '\Voximplamt\Client\Model\AccountDocumentVerifiedCallback',
        'account_is_frozen' => '\Voximplamt\Client\Model\AccountIsFrozenCallback',
        'activate_successful' => '\Voximplamt\Client\Model\ActivateSuccessfulCallback',
        'call_history_report' => '\Voximplamt\Client\Model\CallHistoryReportCallback',
        'card_expired' => '\Voximplamt\Client\Model\CardExpiredCallback',
        'card_expires_in_month' => '\Voximplamt\Client\Model\CardExpiresInMonthCallback',
        'card_payment' => '\Voximplamt\Client\Model\CardPaymentCallback',
        'card_payment_failed' => '\Voximplamt\Client\Model\CardPaymentFailedCallback',
        'js_fail' => '\Voximplamt\Client\Model\JSFailCallback',
        'min_balance' => '\Voximplamt\Client\Model\MinBalanceCallback',
        'regulation_address_verified' => '\Voximplamt\Client\Model\RegulationAddressVerifiedCallback',
        'renewed_subscriptions' => '\Voximplamt\Client\Model\RenewedSubscriptionsCallback',
        'reset_account_password_request' => '\Voximplamt\Client\Model\ResetAccountPasswordRequestCallback',
        'sip_registration_fail' => '\Voximplamt\Client\Model\SIPRegistrationFailCallback',
        'stagnant_account' => '\Voximplamt\Client\Model\StagnantAccountCallback',
        'subscription_is_frozen' => '\Voximplamt\Client\Model\SubscriptionIsFrozenCallback',
        'subscription_is_detached' => '\Voximplamt\Client\Model\SubscriptionIsDetachedCallback',
        'transaction_history_report' => '\Voximplamt\Client\Model\TransactionHistoryReportCallback',
        'uncharged_tariff' => '\Voximplamt\Client\Model\UnchargedTariffCallback',
        'unverified_subscription_detached' => '\Voximplamt\Client\Model\UnverifiedSubscriptionDetachedCallback'
    );
     ...
     * @return \Voximplamt\Client\Model\AccountDocumentVerifiedCallback
     */
     ...
     * @param \Voximplamt\Client\Model\AccountDocumentVerifiedCallback $account_document_verified
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\AccountIsFrozenCallback
     */
     ...
     * @param \Voximplamt\Client\Model\AccountIsFrozenCallback $account_is_frozen
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\ActivateSuccessfulCallback
     */
     ...
     * @param \Voximplamt\Client\Model\ActivateSuccessfulCallback $activate_successful
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\CallHistoryReportCallback
     */
     ...
     * @param \Voximplamt\Client\Model\CallHistoryReportCallback $call_history_report
     * @return $this
     */
    ...
    /**
     * Gets card_expired
     * @return \Voximplamt\Client\Model\CardExpiredCallback
     */
    ...
    /**
     * Sets card_expired
     * @param \Voximplamt\Client\Model\CardExpiredCallback $card_expired
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\CardExpiresInMonthCallback
     */
     ...
     * @param \Voximplamt\Client\Model\CardExpiresInMonthCallback $card_expires_in_month
     * @return $this
     */
    ...
    /**
     * Gets card_payment
     * @return \Voximplamt\Client\Model\CardPaymentCallback
     */
    ...
    /**
     * Sets card_payment
     * @param \Voximplamt\Client\Model\CardPaymentCallback $card_payment
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\CardPaymentFailedCallback
     */
     ...
     * @param \Voximplamt\Client\Model\CardPaymentFailedCallback $card_payment_failed
     * @return $this
     */
    ...
    /**
     * Gets js_fail
     * @return \Voximplamt\Client\Model\JSFailCallback
     */
    ...
    /**
     * Sets js_fail
     * @param \Voximplamt\Client\Model\JSFailCallback $js_fail
     * @return $this
     */
    ...
    /**
     * Gets min_balance
     * @return \Voximplamt\Client\Model\MinBalanceCallback
     */
    ...
    /**
     * Sets min_balance
     * @param \Voximplamt\Client\Model\MinBalanceCallback $min_balance
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\RegulationAddressVerifiedCallback
     */
     ...
     * @param \Voximplamt\Client\Model\RegulationAddressVerifiedCallback $regulation_address_verified
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\RenewedSubscriptionsCallback
     */
     ...
     * @param \Voximplamt\Client\Model\RenewedSubscriptionsCallback $renewed_subscriptions
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\ResetAccountPasswordRequestCallback
     */
     ...
     * @param \Voximplamt\Client\Model\ResetAccountPasswordRequestCallback $reset_account_password_request
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\SIPRegistrationFailCallback
     */
     ...
     * @param \Voximplamt\Client\Model\SIPRegistrationFailCallback $sip_registration_fail
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\StagnantAccountCallback
     */
     ...
     * @param \Voximplamt\Client\Model\StagnantAccountCallback $stagnant_account
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\SubscriptionIsFrozenCallback
     */
     ...
     * @param \Voximplamt\Client\Model\SubscriptionIsFrozenCallback $subscription_is_frozen
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\SubscriptionIsDetachedCallback
     */
     ...
     * @param \Voximplamt\Client\Model\SubscriptionIsDetachedCallback $subscription_is_detached
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\TransactionHistoryReportCallback
     */
     ...
     * @param \Voximplamt\Client\Model\TransactionHistoryReportCallback $transaction_history_report
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\UnchargedTariffCallback
     */
     ...
     * @param \Voximplamt\Client\Model\UnchargedTariffCallback $uncharged_tariff
     * @return $this
     */
     ...
     * @return \Voximplamt\Client\Model\UnverifiedSubscriptionDetachedCallback
     */
     ...
     * @param \Voximplamt\Client\Model\UnverifiedSubscriptionDetachedCallback $unverified_subscription_detached
     * @return $this
     */
