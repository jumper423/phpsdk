...
class ManagingPushCredentialsApi
{
     ...
     * @return \Model\InlineResponse2006
     ...
     * @param int $push_provider_id The push provider id. (optional)
     * @param string $cert_file_name The parameter is required, when set &#x60;cert_content&#x60; as POST body. (optional)
     * @return Array of \Model\InlineResponse2006, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function addPushCredentialWithHttpInfo($external_app_name, $cert_content, $cert_password, $is_dev_mode, $push_provider_name = null, $push_provider_id = null, $cert_file_name = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse2006', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse2006', $e->getResponseHeaders());
     ...
     * @return \Model\InlineResponse20015
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param int $application_id The application id. (required)
     * @param bool $bind Set to false for unbind. Default value is true. (optional)
     * @return Array of \Model\InlineResponse20015, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function bindPushCredentialWithHttpInfo($push_credential_id, $application_id, $bind = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20015', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20015', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Model\InlineResponse20045
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param string $external_app The push provider&#x60;s application name. (optional)
     * @param bool $with_cert Set true to get the user&#x60;s certificate. (optional)
     * @return Array of \Model\InlineResponse20045, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function getPushCredentialWithHttpInfo($push_credential_id = null, $push_provider_name = null, $push_provider_id = null, $application_name = null, $application_id = null, $external_app = null, $with_cert = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20045', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20045', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
