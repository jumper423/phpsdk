...
class ManagingApplicationsApi
{
     ...
     * @return \Model\InlineResponse2003
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return Array of \Model\InlineResponse2003, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function addApplicationWithHttpInfo($application_name, $im_enabled = null, $im_roster_type = null, $busy_on_call = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse2003', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse2003', $e->getResponseHeaders());
     ...
     * @return \Model\InlineResponse20028
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Model\InlineResponse20028, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function getApplicationsWithHttpInfo($application_id = null, $application_name = null, $im_enabled = null, $im_roster_type = null, $user_id = null, $excluded_user_id = null, $showing_user_id = null, $with_rules = null, $with_scenarios = null, $count = null, $offset = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20028', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20028', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return \Model\InlineResponse20063
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param string $im_roster_type The roster type (IM users list type). The following values are possible: personal, group. (optional)
     * @param bool $busy_on_call The busy_on_call flag. (optional)
     * @return Array of \Model\InlineResponse20063, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function setApplicationInfoWithHttpInfo($application_id = null, $required_application_name = null, $application_name = null, $im_enabled = null, $im_roster_type = null, $busy_on_call = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20063', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20063', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
