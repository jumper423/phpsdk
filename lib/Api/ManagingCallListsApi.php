...
class ManagingCallListsApi
{
     ...
     * @return \Model\InlineResponse20013
     ...
     * @param string $encoding Encoding file. The default is UTF-8. (optional)
     * @param string $delimiter Separator values. The default is &#x60;;&#x60; (optional)
     * @return Array of \Model\InlineResponse20013, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function appendToCallListWithHttpInfo($file_content, $list_id = null, $list_name = null, $encoding = null, $delimiter = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20013', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20013', $e->getResponseHeaders());
     ...
     * @param string $delimiter Separator values. The default is &#x60;;&#x60; (optional)
     * @return \Model\InlineResponse20032
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param string $encoding Encoding of the output file. Default UTF-8 (optional)
     * @param string $delimiter Separator values. The default is &#x60;;&#x60; (optional)
     * @return Array of \Model\InlineResponse20032, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function getCallListDetailsWithHttpInfo($list_id, $count = null, $offset = null, $output = null, $encoding = null, $delimiter = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20032', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20032', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Model\InlineResponse20033
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Model\InlineResponse20033, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function getCallListsWithHttpInfo($name = null, $is_active = null, $from_date = null, $to_date = null, $type_list = null, $count = null, $offset = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20033', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20033', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param float $list_id The list Id. (required)
     * @return \Model\InlineResponse20061
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     *
     * @param float $list_id The list Id. (required)
     * @return Array of \Model\InlineResponse20061, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function recoverCallListWithHttpInfo($list_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20061', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20061', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Model\InlineResponse20065
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param float $list_id The list Id. Сan use a set of identifiers with the separator \&quot;;\&quot; (required)
     * @param string $custom_params The custom param. Use to transfer the call initiator parameters to the scenario. (optional)
     * @return Array of \Model\InlineResponse20065, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function startNextCallTaskWithHttpInfo($list_id, $custom_params = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20065', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20065', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param float $list_id The list Id. (required)
     * @return \Model\InlineResponse20067
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     *
     * @param float $list_id The list Id. (required)
     * @return Array of \Model\InlineResponse20067, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function stopCallListProcessingWithHttpInfo($list_id)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20067', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20067', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
