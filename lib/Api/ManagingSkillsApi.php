...
class ManagingSkillsApi
{
     ...
     * @return \Model\InlineResponse20011
     ...
     *
     * @param string $skill_name The ACD operator skill name. The length must be less than 512. (required)
     * @return Array of \Model\InlineResponse20011, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function addSkillWithHttpInfo($skill_name)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20011', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20011', $e->getResponseHeaders());
     ...
     * @return \Model\InlineResponse20054
     * @throws \Voximplant\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Model\InlineResponse20054, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplant\ApiException on non-2xx response
     */
    public function getSkillsWithHttpInfo($skill_id = null, $skill_name = null, $count = null, $offset = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\InlineResponse20054', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\InlineResponse20054', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
