...
class ManagingAccountsApi
{
    ...
    public function getCurrencyRateWithHttpInfo($currency, $date = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20036', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getMoneyAmountToChargeWithHttpInfo($currency = null, $charge_date = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20038', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
    ...
    public function getResourcePriceWithHttpInfo($resource_type = null, $price_group_id = null, $price_group_name = null, $resource_param = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20049', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20049', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function getSubscriptionPriceWithHttpInfo($subscription_template_id = null, $subscription_template_type = null, $subscription_template_name = null, $count = null, $offset = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20055', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20055', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function setAccountDocumentWithHttpInfo($account_document, $verification_name, $is_individual = null, $individual_full_name = null, $individual_birth_date = null, $individual_passport_series = null, $individual_passport_number = null, $individual_passport_issue_date = null, $individual_passport_issued_by = null, $individual_registration_address = null, $legal_entry_full_name = null, $legal_entry_phone = null, $legal_entry_address = null, $legal_entry_actual_address = null, $ogrn = null, $inn = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20062', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20062', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
