...
class ManagingScenariosApi
{
     ...
     * @return \Voximplamt\Client\Model\InlineResponse2009
     ...
     * @param string $scenario_name The scenario name. The length must be less than 30 (required)
     * @param string $scenario_script The scenario text. The length must be less than 128 KB. (required)
     * @return Array of \Voximplamt\Client\Model\InlineResponse2009, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
    public function addScenarioWithHttpInfo($scenario_name, $scenario_script)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplamt\Client\Model\InlineResponse2009',
                '/AddScenario'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplamt\Client\Model\InlineResponse2009', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplamt\Client\Model\InlineResponse2009', $e->getResponseHeaders());
     ...
     * @return \Voximplamt\Client\Model\InlineResponse20051
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Voximplamt\Client\Model\InlineResponse20051, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
    public function getScenariosWithHttpInfo($scenario_id = null, $with_script = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplamt\Client\Model\InlineResponse20051',
                '/GetScenarios'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplamt\Client\Model\InlineResponse20051', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplamt\Client\Model\InlineResponse20051', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplamt\Client\Model\InlineResponse20064
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
     ...
     * @param string $script_custom_data The script custom data (like a script argument). (optional)
     * @param string $reference_ip IPv4 that will be used to find nearest media server. (optional)
     * @return Array of \Voximplamt\Client\Model\InlineResponse20064, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
    public function startConferenceWithHttpInfo($conference_name, $rule_id, $user_id = null, $user_name = null, $script_custom_data = null, $reference_ip = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplamt\Client\Model\InlineResponse20064',
                '/StartConference'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplamt\Client\Model\InlineResponse20064', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplamt\Client\Model\InlineResponse20064', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param string $script_custom_data The script custom data (like a script argument). (optional)
     * @param string $reference_ip IPv4 that will be used to find nearest media server. (optional)
     * @return \Voximplamt\Client\Model\InlineResponse20066
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
     ...
     * @param string $script_custom_data The script custom data (like a script argument). (optional)
     * @param string $reference_ip IPv4 that will be used to find nearest media server. (optional)
     * @return Array of \Voximplamt\Client\Model\InlineResponse20066, HTTP status code, HTTP response headers (array of strings)
     * @throws \Voximplamt\Client\ApiException on non-2xx response
     */
    public function startScenariosWithHttpInfo($rule_id, $user_id = null, $user_name = null, $script_custom_data = null, $reference_ip = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplamt\Client\Model\InlineResponse20066',
                '/StartScenarios'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplamt\Client\Model\InlineResponse20066', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplamt\Client\Model\InlineResponse20066', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
