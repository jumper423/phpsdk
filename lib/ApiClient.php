...
class ApiClient
{
     ...
     */
    public function __construct(\Voximplamt\Client\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \Voximplamt\Client\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\Voximplamt\Client\ObjectSerializer::sanitizeForSerialization($postData));
        }
