...
class ManagingAccountsApi
{
     ...
     * @return \Voximplant\InlineResponse20016
     ...
     * @param string $phone_id The phone ID list separated by the &#x60;;&#x60; symbol or the &#x60;all&#x60; value. You should specify the phones having the auto_charge&#x3D;false. (optional)
     * @param string $phone_number Can be used instead of &lt;b&gt;phone_id&lt;/b&gt;. The phone number list separated by the &#x60;;&#x60; symbol or the &#x60;all&#x60; value. You should specify the phones having the auto_charge&#x3D;false. (optional)
     * @return Array of \Voximplant\InlineResponse20016, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function chargeAccountWithHttpInfo($phone_id = null, $phone_number = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20016',
                '/ChargeAccount'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20016', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20016', $e->getResponseHeaders());
     ...
     * @return \Voximplant\InlineResponse20023
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $child_account_id The child account ID list separated by the &#x60;;&#x60; symbol or the &#x60;all&#x60; value. (optional)
     * @param bool $children_verifications_only Set true to get the children account verifications only. (optional)
     * @return Array of \Voximplant\InlineResponse20023, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAccountDocumentsWithHttpInfo($with_details = null, $verification_name = null, $verification_status = null, $from_unverified_hold_until = null, $to_unverified_hold_until = null, $child_account_id = null, $children_verifications_only = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20023',
                '/GetAccountDocuments'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20023', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20023', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20024
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param bool $return_live_balance Set true to get the account&#x60;s live balance. (optional)
     * @return Array of \Voximplant\InlineResponse20024, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAccountInfoWithHttpInfo($return_live_balance = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20024',
                '/GetAccountInfo'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20024', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20024', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20036
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $currency The currency code list separated by the &#x60;;&#x60; symbol. Examples: RUR, EUR, USD (required)
     * @param string $date The date, format: YYYY-MM-DD (optional)
     * @return Array of \Voximplant\InlineResponse20036, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getCurrencyRateWithHttpInfo($currency, $date = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20036',
                '/GetCurrencyRate'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20036', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20036', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20038
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $currency The currency name. Examples: USD, RUR, EUR. (optional)
     * @param string $charge_date The next charge date, format: YYYY-MM-DD (optional)
     * @return Array of \Voximplant\InlineResponse20038, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getMoneyAmountToChargeWithHttpInfo($currency = null, $charge_date = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20038',
                '/GetMoneyAmountToCharge'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20038', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20038', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20049
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $price_group_name The price group name template to filter. (optional)
     * @param string $resource_param The resource parameter list separated by the &#x60;;&#x60; symbol. Example: a phone number list. (optional)
     * @return Array of \Voximplant\InlineResponse20049, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getResourcePriceWithHttpInfo($resource_type = null, $price_group_id = null, $price_group_name = null, $resource_param = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20049',
                '/GetResourcePrice'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20049', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20049', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20055
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Voximplant\InlineResponse20055, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSubscriptionPriceWithHttpInfo($subscription_template_id = null, $subscription_template_type = null, $subscription_template_name = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20055',
                '/GetSubscriptionPrice'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20055', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20055', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20062
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $ogrn The OGRN of the legal entry. (optional)
     * @param string $inn The INN of the legal entry. (optional)
     * @return Array of \Voximplant\InlineResponse20062, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function setAccountDocumentWithHttpInfo($account_document, $verification_name, $is_individual = null, $individual_full_name = null, $individual_birth_date = null, $individual_passport_series = null, $individual_passport_number = null, $individual_passport_issue_date = null, $individual_passport_issued_by = null, $individual_registration_address = null, $legal_entry_full_name = null, $legal_entry_phone = null, $legal_entry_address = null, $legal_entry_actual_address = null, $ogrn = null, $inn = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20062',
                '/SetAccountDocument'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20062', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20062', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
