...
class ManagingPhoneNumbersApi
{
     ...
     * @return \Voximplant\InlineResponse20014
     ...
     * @param string $country_state The country state. See the GetPhoneNumberCategories and GetPhoneNumberCountryStates functions. (optional)
     * @param float $regulation_address_id The phone regulation address ID. (optional)
     * @return Array of \Voximplant\InlineResponse20014, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function attachPhoneNumberWithHttpInfo($country_code, $phone_category_name, $phone_region_id, $phone_count = null, $phone_number = null, $country_state = null, $regulation_address_id = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20014',
                '/AttachPhoneNumber'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20014', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20014', $e->getResponseHeaders());
     ...
     * @return \Voximplant\InlineResponse20025
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $phone_category_name The phone category name. See the GetPhoneNumberCategories function. (required)
     * @param float $phone_region_id The phone region ID to filter. (required)
     * @return Array of \Voximplant\InlineResponse20025, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getActualPhoneNumberRegionWithHttpInfo($country_code, $phone_category_name, $phone_region_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20025',
                '/GetActualPhoneNumberRegion'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20025', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20025', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20039
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Voximplant\InlineResponse20039, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getNewPhoneNumbersWithHttpInfo($country_code, $phone_category_name, $phone_region_id, $country_state = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20039',
                '/GetNewPhoneNumbers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20039', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20039', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20040
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $country_code The country code. (optional)
     * @param string $sandbox Flag allows you to display phone number categories only of the sandbox, real or all .The following values are possible: &#x60;all&#x60;, &#x60;true&#x60;, &#x60;false&#x60;. (optional)
     * @return Array of \Voximplant\InlineResponse20040, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getPhoneNumberCategoriesWithHttpInfo($country_code = null, $sandbox = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20040',
                '/GetPhoneNumberCategories'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20040', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20040', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20041
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $phone_category_name The phone category name. See the GetPhoneNumberCategories function. (required)
     * @param string $country_state The country state code (example: AL, CA, ... ). (optional)
     * @return Array of \Voximplant\InlineResponse20041, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getPhoneNumberCountryStatesWithHttpInfo($country_code, $phone_category_name, $country_state = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20041',
                '/GetPhoneNumberCountryStates'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20041', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20041', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20042
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $phone_region_name The phone region name to filter. (optional)
     * @param string $phone_region_code The region phone prefix to filter. (optional)
     * @return Array of \Voximplant\InlineResponse20042, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getPhoneNumberRegionsWithHttpInfo($country_code, $phone_category_name, $country_state = null, $omit_empty = null, $phone_region_id = null, $phone_region_name = null, $phone_region_code = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20042',
                '/GetPhoneNumberRegions'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20042', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20042', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return \Voximplant\InlineResponse20043
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param float $count The max returning record count. (optional)
     * @param float $offset The record count to omit. (optional)
     * @return Array of \Voximplant\InlineResponse20043, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getPhoneNumbersWithHttpInfo($phone_id = null, $application_id = null, $application_name = null, $is_bound_to_application = null, $phone_template = null, $country_code = null, $phone_category_name = null, $canceled = null, $deactivated = null, $auto_charge = null, $from_phone_next_renewal = null, $to_phone_next_renewal = null, $from_phone_purchase_date = null, $to_phone_purchase_date = null, $child_account_id = null, $children_phones_only = null, $verification_name = null, $verification_status = null, $from_unverified_hold_until = null, $to_unverified_hold_until = null, $can_be_used = null, $order_by = null, $sandbox = null, $count = null, $offset = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20043',
                '/GetPhoneNumbers'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20043', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20043', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
