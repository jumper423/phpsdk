...
class ManagingSIPRegistrationApi
{
     ...
     * @return \Voximplant\InlineResponse20019
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $outbound_proxy The outbound SIP proxy (optional)
     * @param string $password The SIP password (optional)
     * @return Array of \Voximplant\InlineResponse20019, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function createSipRegistrationWithHttpInfo($username, $proxy, $auth_user = null, $outbound_proxy = null, $password = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20019',
                '/CreateSipRegistration'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20019', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20019', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     * @return \Voximplant\InlineResponse20052
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     * @param string $username The SIP user name to filter. (optional)
     * @param bool $deactivated Set true to show the frozen SIP registrations only. (optional)
     * @return Array of \Voximplant\InlineResponse20052, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSipRegistrationsWithHttpInfo($sip_registration_id = null, $username = null, $deactivated = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Voximplant\InlineResponse20052',
                '/GetSipRegistrations'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Voximplant\InlineResponse20052', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Voximplant\InlineResponse20052', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
