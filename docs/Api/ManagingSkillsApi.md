# Voximplant\Client\ManagingSkillsApi
...
# **addSkill**
> \Voximplant\Client\Model\InlineResponse20011 addSkill($skill_name)
...
$api_instance = new Voximplant\Client\Api\ManagingSkillsApi();
...
[**\Voximplant\Client\Model\InlineResponse20011**](../Model/InlineResponse20011.md)
...
# **bindSkill**
> \Voximplant\Client\Model\InlineResponse200 bindSkill($skill_id, $skill_name, $user_id, $user_name, $acd_queue_id, $acd_queue_name, $bind)
...
# **delSkill**
> \Voximplant\Client\Model\InlineResponse200 delSkill($skill_id, $skill_name)
...
# **getSkills**
> \Voximplant\Client\Model\InlineResponse20054 getSkills($skill_id, $skill_name, $count, $offset)
...
[**\Voximplant\Client\Model\InlineResponse20054**](../Model/InlineResponse20054.md)
...
# **setSkillInfo**
> \Voximplant\Client\Model\InlineResponse200 setSkillInfo($new_skill_name, $skill_id, $skill_name)
