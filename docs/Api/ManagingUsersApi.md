# Voximplant\Client\ManagingUsersApi
...
# **addUser**
> \Voximplant\Client\Model\InlineResponse20012 addUser($user_name, $user_display_name, $user_password, $parent_accounting, $two_factor_auth_required, $mobile_phone, $user_active, $user_custom_data)
...
$api_instance = new Voximplant\Client\Api\ManagingUsersApi();
...
[**\Voximplant\Client\Model\InlineResponse20012**](../Model/InlineResponse20012.md)
...
# **bindUser**
> \Voximplant\Client\Model\InlineResponse200 bindUser($user_id, $user_name, $application_id, $application_name, $bind)
...
# **delUser**
> \Voximplant\Client\Model\InlineResponse200 delUser($user_id, $user_name)
...
[**\Voximplant\Client\Model\InlineResponse20057**](../Model/InlineResponse20057.md)
...
# **setUserInfo**
> \Voximplant\Client\Model\InlineResponse200 setUserInfo($user_id, $user_name, $new_user_name, $user_display_name, $user_password, $parent_accounting, $user_active, $user_custom_data, $two_factor_auth_required, $mobile_phone)
...
# **transferMoneyToUser**
> \Voximplant\Client\Model\InlineResponse20068 transferMoneyToUser($user_id, $amount, $currency, $strict_mode, $user_transaction_description, $account_transaction_description)
...
[**\Voximplant\Client\Model\InlineResponse20068**](../Model/InlineResponse20068.md)
