...
# **addAdminRole**
> \Voximplant\Model\AddAdminRoleAPIResponse addAdminRole($admin_role_name, $admin_role_active, $like_admin_role_id, $like_admin_role_name, $allowed_entries, $denied_entries)
...
[**\Voximplant\Model\AddAdminRoleAPIResponse**](../Model/AddAdminRoleAPIResponse.md)
...
# **delAdminRole**
> \Voximplant\Model\ActivateCallerIDAPIResponse delAdminRole($admin_role_id, $admin_role_name)
...
# **getAdminRoles**
> \Voximplant\Model\GetAdminRolesAPIResponse getAdminRoles($admin_role_id, $admin_role_name, $admin_role_active, $with_entries, $with_account_roles, $with_parent_roles, $with_system_roles, $included_admin_user_id, $excluded_admin_user_id, $full_admin_users_matching, $showing_admin_user_id, $count, $offset)
...
[**\Voximplant\Model\GetAdminRolesAPIResponse**](../Model/GetAdminRolesAPIResponse.md)
...
# **setAdminRoleInfo**
> \Voximplant\Model\ActivateCallerIDAPIResponse setAdminRoleInfo($admin_role_id, $admin_role_name, $new_admin_role_name, $admin_role_active, $entry_modification_mode, $allowed_entries, $denied_entries, $like_admin_role_id, $like_admin_role_name)
