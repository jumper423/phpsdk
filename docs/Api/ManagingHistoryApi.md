...
$api_instance = new Voximplant\Api\ManagingHistoryApi();
...
# **getACDHistory**
> \Model\InlineResponse20021 getACDHistory($from_date, $to_date, $acd_session_history_id, $acd_queue_id, $user_id, $operator_hangup, $unserviced, $min_waiting_time, $rejected, $with_events, $with_header, $desc_order, $count, $offset, $output)
...
[**\Model\InlineResponse20021**](../Model/InlineResponse20021.md)
...
[**\Model\InlineResponse20031**](../Model/InlineResponse20031.md)
...
# **getHistoryReports**
> \Model\InlineResponse20037 getHistoryReports($history_report_id, $history_type, $created_from, $created_to, $is_completed, $desc_order, $count, $offset)
...
[**\Model\InlineResponse20037**](../Model/InlineResponse20037.md)
...
> \Model\InlineResponse20056 getTransactionHistory($from_date, $to_date, $timezone, $transaction_id, $payment_reference, $transaction_type, $user_id, $child_account_id, $children_transactions_only, $users_transactions_only, $desc_order, $count, $offset, $output, $is_async)
...
[**\Model\InlineResponse20056**](../Model/InlineResponse20056.md)
